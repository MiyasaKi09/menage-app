-- ============================================
-- SCRIPT COMPLET - INITIALISATION + GÉNÉRATION
-- ============================================
-- Initialise next_due_at ET génère 7 jours de planning
...
BEGIN
  ...
  -- ========================================
  -- ÉTAPE 2: INITIALISER NEXT_DUE_AT
  -- ========================================
  RAISE NOTICE '════════════════════════════════════════';
  ...
  -- ========================================
  -- ÉTAPE 3: RÉCUPÉRER LE BUDGET TEMPS
  -- ========================================
  ...
  -- ========================================
  -- ÉTAPE 4: GÉNÉRER PLANNING POUR 7 JOURS
  -- ========================================
  FOR i IN 0..6 LOOP
  ...
  RAISE NOTICE '════════════════════════════════════════';
  RAISE NOTICE 'Actualisez /tasks/schedule pour voir le planning';
  RAISE NOTICE '════════════════════════════════════════';
END;
$$;
